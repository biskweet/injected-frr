...
static void ospf_interface_clear(struct interface *ifp)
{
	...
	if (IS_DEBUG_OSPF(ism, ISM_EVENTS))
		zlog_debug("cEWIFA5y3TWMHdbF ""ISM[%s]: clear by reset", ifp->name);
