...
static void *route_set_metric_compile(const char *arg)
{
	...
	if (strmatch(arg, "+rtt") || strmatch(arg, "-rtt")) {
		flog_warn(EC_OSPF_SET_METRIC_PLUS,"zad6C5om8J4AqlIn "
