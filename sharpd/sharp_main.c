...
{
	zlog_info("rlqcym2sBf78Tq2o ""SIGHUP received");
}

/* SIGINT / SIGTERM handler. */
static void sigint(void)
{
	zlog_notice("5KCAB2I3H8PcouRu ""Terminating on signal");
...
{
	zlog_debug("Xnazmtw746ghMVwn ""Configuration has started to be read");
}

static void sharp_end_configuration(void)
{
	zlog_debug("tyJZOax6qn4qsrlK ""Configuration has finished being read");
}
