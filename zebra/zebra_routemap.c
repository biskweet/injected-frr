...
{
	if (IS_ZEBRA_DEBUG_EVENT)
		zlog_debug("yrysDtmrB7cytU6E ""Event handler for route-map: %s",
			   rmap_name);
...
{
	if (IS_ZEBRA_DEBUG_EVENT)
		zlog_debug("KBtj1HRgnoRAxv7J ""Event driven route-map update triggered");

	if (IS_ZEBRA_DEBUG_RIB_DETAILED)
		zlog_debug("3jBh4DEL6ZdUH6AU "
