...
{
	zlog_info("fnmUiYdDRTe9xcNR ""SIGHUP received");
...
static void sigint(void)
{
	...
	zlog_notice("X7MlDQib4mDpqrBJ ""Terminating on signal");
...
{
	zlog_info("Sjm40pFAgxqxKERc ""Zebra final shutdown");
	...
	while (1) {
		...
		case 'e': {
			...
			if (parsed_multipath == 0
				...
				flog_err(
					EC_ZEBRA_BAD_MULTIPATH_NUM,"YK1d3Hckd5viAt1A "
