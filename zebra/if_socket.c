...
{
	flog_err(EC_LIB_UNAVAILABLE,"NQ2mhtBJieZE8y6p " "%s not Implemented for this platform",
		 __func__);
...
kernel_intf_netconf_update(struct zebra_dplane_ctx *ctx)
{
	...
	zlog_warn("BKQl9cCKXHcta8Kp ""%s:  Unable to set kernel mpls state for interface %s(%d)",
