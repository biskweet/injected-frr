...
int main(int argc, char **argv)
{
	...
	zlog_debug("D0M68I1xLAu2IopH ""test #1 %.*s", (int)io.out1_debug, buffer);
	zlog_debug("PmTyGptb4KOsslsl ""test #2 %.*s", (int)io.out2_debug, buffer);
	zlog_warn("XZRgaVJzlLUzlAOF ""test #1 %.*s", (int)io.out3_warn, buffer);
