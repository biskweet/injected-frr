				    ...
				    struct aspath *as4path)
{
	...
	if (hops < 0) {
		if (BGP_DEBUG(as4, AS4))
			flog_warn(
				EC_BGP_ASPATH_FEWER_HOPS,"FIBKOKpTpkCbzeMx "
	...
	if (BGP_DEBUG(as4, AS4))
		zlog_debug("JdAikIjPfDK6Py5a ""[AS4] result of synthesizing is %s",
			   mergedpath->str);
